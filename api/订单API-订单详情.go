...
type (
	...
	RespGetOrderDetailData struct {
		...
		BoundExtendInfo             BoundExtendInfo           `json:"boundExtendInfo"`
		TransferExtendInfo          TransferExtendInfo        `json:"transferExtendInfo"`
		OpenAddressId               string                    `json:"openAddressId"`
		SimpleDeliveryOrderList     []SimpleDeliveryOrderList `json:"simpleDeliveryOrderList"`
